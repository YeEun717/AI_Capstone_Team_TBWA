...
st.sidebar.markdown("""
    <div style="display: flex; justify-content: space-between;">
        <a href="https://comment-generate-dashboard.streamlit.app/" style="color: #666666; text-decoration: none; font-size: 12px;">📈웹사이트 바로가</a>
...
st.markdown('<p class="general-text" style="margin-left: 40px;">📌 위에서 선택한 데이터를 다음과 같이 확인할 수 있습니다.</p>', unsafe_allow_html=True)
...
st.markdown('<p class="general-text" style="margin-left: 40px;">📌 매체비에 대한 KPI 달성률이 원 그래프로 표시됩니다</p>', unsafe_allow_html=True)
...
st.markdown('<p class="general-text" style="margin-left: 40px;">📌 그래프 위에 마우스를 갖다대면 특정 위치의 상세 지표 값을 확인할 수 있습니다.</p>', unsafe_allow_html=True)
...
st.markdown('<p class="general-text" style="margin-left: 40px;">📌 선택상자를 통해 비교하고 싶은 기준 일자를 선택하고, 전날 대비 비교 기준 일자의 각 지표 변화율을 확인할 수 있습니다.</p>', unsafe_allow_html=True)
st.image('data/7.png', caption='')
...
st.markdown('<p class="general-text" style="margin-left: 40px;">📌 코멘트를 생성하고 싶은 일자를 선택하고, OpenAI API key를 입력합니다.</p>', unsafe_allow_html=True)
